...
func get_stage(id: String) -> StageData:
...
func get_stage_missions(stage_id: String) -> Array:
	var stage: StageData = get_stage(stage_id)
	if stage == null:
		return []
...
func _register_stage1() -> void:
	...
	m1.type                 = MissionData.MissionType.INCURSION
	m1.objective_type       = MissionData.ObjectiveType.SURVIVE_WAVES
	m1.max_waves            = 5
	...
	m2.type                 = MissionData.MissionType.INCURSION
	m2.objective_type       = MissionData.ObjectiveType.ACTIVATE_BEACONS
	...
	m3.type                 = MissionData.MissionType.INCURSION
	m3.objective_type       = MissionData.ObjectiveType.COLLECT_CACHES
	...
	m4.type                    = MissionData.MissionType.INCURSION
	m4.objective_type          = MissionData.ObjectiveType.CLOSE_BURROWS
	...
	m5.type                 = MissionData.MissionType.SURVIVAL
	m5.objective_type       = MissionData.ObjectiveType.KILL_BOSS
